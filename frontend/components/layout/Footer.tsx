            ...
            <div className="container relative z-10 px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="flex items-center gap-2 text-2xl font-bold font-space-grotesk tracking-tighter">
                            ...
                            <span className="text-white">GFG<span className="text-primary">.SC</span></span>
                        </div>
                        ...
                        <div className="flex gap-4">
                            {[Github, Twitter, Linkedin, Mail].map((Icon, i) => (
                                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-black transition-all duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-muted-foreground">
                            {['Events', 'Projects', 'Team', 'Blog', 'Gallery'].map((link) => (
                                <li key={link}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-muted-foreground">
                            {['Join Discord', 'GitHub Org', 'Resources', 'Code of Conduct', 'Partners'].map((link) => (
                                <li key={link}>
                                    <a href="#" className="hover:text-secondary transition-colors flex items-center gap-2 group">
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-muted-foreground text-center md:text-left">
                        © 2024 GFG Student Chapter. All systems operational.
                    </p>
