...
export function HeroSectionV2() {
    ...
    return (
        <section
            ...
            className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#030303] selection:bg-primary/30"
        >
            ...
            >
                ...
                <div className="relative mb-8 md:mb-12 max-w-5xl mx-auto">
                    ...
                    <motion.div
                        ...
                        className="relative w-32 h-32 md:w-48 md:h-48 mb-8 mx-auto"
                    >
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-bold tracking-tighter leading-[0.9] font-space-grotesk">
                        <span className="block text-white mb-2 md:mb-4 drop-shadow-2xl">
                            GeeksforGeeks
                        </span>
                        <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary via-white to-primary bg-300% animate-gradient text-4xl md:text-6xl lg:text-[5rem]">
                            campus body ITER
                        </span>
                    </h1>
                ...
                <motion.div
                    ...
                    className="w-full max-w-2xl bg-[#0a0a0a]/90 border border-white/10 rounded-lg overflow-hidden backdrop-blur-xl shadow-2xl mb-12 group hover:border-primary/30 transition-colors duration-500 will-change-transform"
                >
                    {/* Terminal Header */}
